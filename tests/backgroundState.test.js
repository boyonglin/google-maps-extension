...
describe("backgroundState.js - URL Building Functions", () => {
  ...
  describe("buildSearchUrl", () => {
    ...
    test("should build search URL with Unicode characters", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps?authuser=0&q=%E6%9D%B1%E4%BA%AC%E3%82%BF%E3%83%AF%E3%83%BC"
      );
    });
  ...
  describe("buildDirectionsUrl", () => {
    test("should build directions URL with origin and destination", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps/dir/?authuser=0&api=1&origin=San%20Francisco&destination=Los%20Angeles"
      );
    });
    ...
    test("should build directions URL with special characters", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps/dir/?authuser=0&api=1&origin=caf%C3%A9%20%26%20bar&destination=restaurant%20%26%20grill"
      );
    });
    ...
    test("should handle empty origin", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps/dir/?authuser=0&api=1&origin=&destination=Los%20Angeles"
      );
    });
    ...
    test("should handle empty destination", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps/dir/?authuser=0&api=1&origin=San%20Francisco&destination="
      );
    });
    ...
    test("should build directions URL with coordinates", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps/dir/?authuser=0&api=1&origin=40.7128%2C-74.0060&destination=34.0522%2C-118.2437"
      );
    });
    ...
    test("should build directions URL with updated authUser", () => {
      ...
      expect(result).toBe(
        "https://www.google.com/maps/dir/?authuser=7&api=1&origin=Tokyo&destination=Osaka"
      );
    });
...
describe("backgroundState.js - Integration & Performance Tests", () => {
  ...
  test("should handle concurrent ensureWarm calls with decryption", async () => {
    ...
    // Make multiple concurrent calls
    const results = await Promise.all([ensureWarm(), ensureWarm(), ensureWarm()]);
