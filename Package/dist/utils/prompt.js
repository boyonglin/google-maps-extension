/**
 * Gemini AI prompt templates for various features
 * @module utils/prompt
 */

/**
 * Prompt template for summarizing page content and extracting landmarks
 * @type {string}
 */
...
/**
 * Prompt template for attaching Google Maps links to places on web pages
 * @type {string}
 */
...
/**
 * Prompt template for organizing locations into categories
 * @type {string}
 */
...
/**
 * Prompt template for AI-generated itinerary suggestions
 * @type {string}
 */
...
/**
 * Collection of Gemini AI prompt templates
 * @typedef {Object} GeminiPrompts
 * @property {string} summary - Prompt for extracting landmarks from page content
 * @property {string} attach - Prompt for identifying places to attach map links
 * @property {string} organize - Prompt for categorizing location collections
 * @property {string} askAI - Prompt for generating travel itineraries
 */
